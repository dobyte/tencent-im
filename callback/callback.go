...
// SyncListen
func (c *callback) SyncListen(w http.ResponseWriter , r *http.Request) {
...
func (c *callback) AsyncListen(r *http.Request) {

}

// handleEvent 处理监听事件
func (c *callback) handleEvent(event EventType, data interface{}) error {
...
func (c *callback) parseCommand(command string) (event EventType, data interface{}, err error) {
    switch command {
